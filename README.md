...
tidal-lang-type-dock is a Julia project for compilers. It focuses on this technical goal: Create a Julia reference implementation for type workflows, centered on format conversion, round-trip fixtures, and lossless normalization checks.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 173, risk penalty 7, latency penalty 2, and weight bonus 5. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
