"""Regression checks for the tidal-lang-type-dock casebook."""
...
from casebook.harness import assert_expected, tidal_lang_type_dock_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(tidal_lang_type_dock_summary(), assert_expected())
